...
class Bank():
    ...
    def close_account(self):
        ...
        if the_balance is not None:
            ...
            def self.accounts_dict[user_account_number]
    ...
    def deposit(self):
        ...
        user_account_password = input("Please enter the passsword: ")
        
        account = self.accounts_dict[account_num]
        the_deposit = account.deposit(deposit_amount, user_account_password)
